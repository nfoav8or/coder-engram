...
| `reindex_vault` | Rebuild the index from the vault. | **Rate-limited** (15 s cooldown), checked before anything else so a refusal is never free to flood. Refused when indexing is disabled. |
